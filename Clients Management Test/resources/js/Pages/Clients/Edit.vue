...
let client = usePage().props.client.data;


const form = useForm({
    name: client.name,
    email: client.email,
    class_id: client.class.id,
    section_id: client.section.id,
});
                    ...
                    <form @submit.prevent="updateClient">
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select
                                            ...
                                            :form.errors.name}"
                                        >
                                            <option valueprops.clients.name>
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    class="bg-indigo-600 border border-transparent 
                                    rounded-md shadow-sm py-2 px-4 inline-flex 
                                    justify-center text-sm font-medium text-white 
